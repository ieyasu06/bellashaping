...
<body>
  ...
  <section id="hero" class="hero d-flex align-items-center">
    <video id="video1" preload="" autoplay="" muted="" playsinline="" loop="" style="width:100%; position: absolute; transform: rotateY(180deg); -webkit-transform:rotateY(180deg); /* Safari and Chrome */ -moz-transform:rotateY(180deg); /*height: 100vh;*/ padding-top: 60px; object-fit: fill;">
